...
# Title: Reciever_CSI
# Author: Carter Moore
# Description: Receiver for channel state estimation test
...
class rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Reciever_CSI", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Reciever_CSI")
        ...
        self.qtgui_number_sink_1.set_title("csi_phase")
        ...
        self.qtgui_number_sink_0.set_title("csi_mag")
        ...
        self.qtgui_freq_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, 0.0, 0, "packet_len")
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, firdes.low_pass(1, samp_rate, samp_rate/2, 100e3), (-lo_offset), samp_rate)
        ...
        self.blocks_moving_average_xx_0 = blocks.moving_average_cc(127, 1, 4000, 1)
        ...
        self.connect((self.blocks_complex_to_magphase_0, 0), (self.qtgui_number_sink_0, 0))
        self.connect((self.blocks_complex_to_magphase_0, 1), (self.qtgui_number_sink_1, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_complex_to_magphase_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_xlating_fir_filter_xxx_0.set_taps(firdes.low_pass(1, self.samp_rate, self.samp_rate/2, 100e3))
