...
# Title: Transmitter_CSI
# Author: Carter Moore
# Description: Transmitter for channel state estimation test
...
class tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Transmitter_CSI", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Transmitter_CSI")
        ...
        self.uhd_usrp_sink_0.set_center_freq(uhd.tune_request(target_freq, lo_offset), 0)
    ...
    def set_target_freq(self, target_freq):
        ...
        self.uhd_usrp_sink_0.set_center_freq(uhd.tune_request(self.target_freq, self.lo_offset), 0)
