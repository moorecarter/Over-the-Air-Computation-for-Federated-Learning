...
class Amp_Encoding_Tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Amp_Encoding_Tx")
        ...
        self._samp_rate_range = qtgui.Range(0, 1000000, 1000, 1e6, 200)
        ...
        self._amplitude_range = qtgui.Range(0, 1000, 1, 0.2, 200)
