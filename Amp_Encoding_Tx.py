...
class Amp_Encoding_Tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Amp_Encoding_Tx")
        ...
        self.carrier_freq = carrier_freq = 2450000000
        ...
        self._samp_rate_range = qtgui.Range(0, 1000000, 1000, 100000, 200)
        ...
        self._amplitude_range = qtgui.Range(0, 1, 1, 0.5, 200)
        ...
        self.analog_const_source_x_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, amplitude)
    ...
    def set_amplitude(self, amplitude):
        ...
        self.analog_const_source_x_0.set_offset(self.amplitude)




def main(top_block_cls=Amp_Encoding_Tx, options=None):
