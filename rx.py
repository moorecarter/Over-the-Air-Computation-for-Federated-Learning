...
class rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.filter_fft_rrc_filter_0 = filter.fft_filter_ccf(1, firdes.root_raised_cosine(1, samp_rate, 250e3, 0.35, 51), 1)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/trask-smith/workspace/rx.txt', False)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_simple_squelch_cc_0, 0), (self.filter_fft_rrc_filter_0, 0))
        ...
        self.connect((self.filter_fft_rrc_filter_0, 0), (self.digital_gmsk_demod_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.filter_fft_rrc_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, 250e3, 0.35, 51))
