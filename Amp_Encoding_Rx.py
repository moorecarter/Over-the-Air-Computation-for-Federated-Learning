...
class Amp_Encoding_Rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Amp_Encoding_Rx")
...
def main(top_block_cls=Amp_Encoding_Rx, options=None):
